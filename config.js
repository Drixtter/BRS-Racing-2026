...
const CONFIG = {
  ...
  calendario: {
    ...
    legacy: [
      ...
      { r:  2, track: "Bélgica",        date: "04/10", type: "Forfun", pistasIdx: 25 },
      { r:  3, track: "Singapura",      date: "11/10", type: "Oficial", pistasIdx: 26 },
      { r:  4, track: "Áustria",        date: "18/10", type: "Forfun", pistasIdx: 27 },
      ...
      { r:  8, track: "Arábia Saudita", date: "15/11", type: "Forfun", pistasIdx: 31 },
      { r:  9, track: "Las Vegas",      date: "22/11", type: "Oficial", pistasIdx: 32 },
      { r: 10, track: "Qatar",          date: "29/11", type: "Oficial", pistasIdx: 33 },
      { r: 11, track: "Grã-Bretanha",   date: "06/12", type: "Forfun", pistasIdx: 34 },
